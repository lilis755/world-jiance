 ...
 * Fallback: GLM -> Ollama -> Groq -> OpenRouter -> Browser T5
 *
...
export type SummarizationProvider = 'glm' | 'ollama' | 'groq' | 'openrouter' | 'browser' | 'cache';
...
export interface SummarizeOptions {
  skipCloudProviders?: boolean;  // true = skip GLM/Ollama/Groq/OpenRouter, go straight to browser T5
...
const API_PROVIDERS: ApiProviderDef[] = [
  { featureId: 'aiGlm',         provider: 'glm',        label: 'GLM-4' },
...
/**
 * Generate a summary using the fallback chain: GLM -> Ollama -> Groq -> OpenRouter -> Browser T5
